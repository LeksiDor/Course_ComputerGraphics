...
private:
    ...
    void createTextureImage()
    {
        ...
        texture.Reset( texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_IMAGE_TILING_OPTIMAL, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT );
        ...
        copyBufferToImage( stagingBuffer, texture.Handle(), static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight) );
